...
function ScmPanel(props) {
    ...
    const branchesView = (0, react_1.createElement)('div', { style: S.body }, (0, react_1.createElement)('div', { style: { ...S.sectionHead, textTransform: 'none', flexWrap: 'wrap' } }, (0, react_1.createElement)('input', {
        ...
        : null, ...visibleBranches.map(branch => (0, react_1.createElement)('div', { key: `${branch.remote ? 'r' : 'l'}:${branch.name}`, style: S.row, title: branch.subject }, (0, react_1.createElement)('span', { style: { ...S.badge, color: branch.current ? TOKEN.ok : TOKEN.dim } }, branch.current ? '●' : branch.remote ? '☁' : '○'), (0, react_1.createElement)('span', { style: S.path }, branch.name), (0, react_1.createElement)('span', { style: { ...S.dim, fontSize: 11 } }, branch.shortHash), branch.current || branch.remote
        ? null
