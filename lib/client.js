...
function ScmPanel(props) {
    ...
    const changesView = (0, react_1.createElement)('div', { style: S.body }, ...sections
        ...
        : null);
    const branchesView = (0, react_1.createElement)('div', { style: S.body }, (0, react_1.createElement)('div', { style: { ...S.sectionHead, textTransform: 'none' } }, (0, react_1.createElement)('input', {
        value: newBranch,
        placeholder: '新分支名…',
        ...
        onClick: () => {
            ...
            void run(`新建分支 ${name}`, async () => {
                await (0, api_js_1.call)('branch-create', sessionId, { repo: repoRef.current, name });
                setNewBranch('');
                return `已创建并切换到 ${name}`;
            });
        },
    ...
    }, '新建'), (0, react_1.createElement)('button', {
        style: S.iconButton,
        title: '清理已失效的工作树记录',
